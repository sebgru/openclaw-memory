...
class QdrantTests(unittest.TestCase):
    def test_upsert_and_search_payload(self):
        ...
        class Response:
            ...
            def read(self): return b'{"result":[{"id":"x","score":0.9,"payload":{"path":"a.md","text":"hello"}}]}'
        def fake(req, timeout):
            calls.append((req.get_method(), req.full_url)); return Response()
        ...
        self.assertEqual(result[0]["path"], "a.md"); self.assertGreaterEqual(len(calls), 2)
